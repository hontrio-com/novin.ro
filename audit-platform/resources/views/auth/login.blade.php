...
<title>Conectare — Inovex Audit</title>
...
<div class="wrap">
    ...
    <div class="right">
        <div class="box">
            <div class="box-title">Bun venit inapoi</div>
            <div class="box-sub">Nu ai cont? <a href="{{ route('register') }}">Creeaza unul gratuit</a></div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row">
                    ...
                    @if(Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="forgot">Ai uitat parola?</a>
                    @endif
                </div>
