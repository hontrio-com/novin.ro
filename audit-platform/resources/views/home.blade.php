@extends('layouts.app')
@section('title', 'Inovex Audit powered by AI')
@section('meta_description', 'Raport complet AI in 60 de secunde: SEO, viteza, GDPR, ANPC, E-E-A-T, UX. 200 RON, fara abonament.')
