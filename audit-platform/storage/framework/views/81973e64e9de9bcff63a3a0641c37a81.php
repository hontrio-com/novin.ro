...
<div class="wrap">
        ...
        <a href="<?php echo e(route('home')); ?>" class="logo">
            <div class="logo-mark">
                <?php if(file_exists(public_path('images/logo.png'))): ?>
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="NOVIN.RO" style="height:36px;width:auto;filter:brightness(0) invert(1);opacity:.9;">
                <?php else: ?>
    ...
    <div class="right">
        <div class="mobile-logo">
            <?php if(file_exists(public_path('images/logo.png'))): ?>
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="NOVIN.RO" style="height:40px;">
            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="foot">
                Nu ai cont? <a href="<?php echo e(route('register')); ?>">Creeaza unul gratuit</a>
            </div>
        </div>
    </div>
</div>
</body>
</html><?php /**PATH C:\Users\iorda\Desktop\audit_inovex\audit-platform\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>