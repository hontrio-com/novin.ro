...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'NOVIN.RO — Audit Website AI | SEO, Viteza, GDPR, ANPC'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Audit profesional AI pentru website-ul tau. SEO, viteza, GDPR, ANPC, E-E-A-T. Raport PDF in 60 de secunde.'); ?>"/>
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'NOVIN.RO - Audit Website AI'); ?>"/>
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'Audit complet al site-ului tau in mai putin de 60 de secunde.'); ?>"/>
    <meta property="og:image" content="<?php echo e(asset('images/og-novin.jpg')); ?>"/>
    ...
    <div class="navbar-inner">
        <a href="<?php echo e(route('home')); ?>" class="nav-logo">
            <?php if(file_exists(public_path('images/logo.png'))): ?>
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="NOVIN.RO" class="nav-logo-img"/>
            <?php elseif(file_exists(public_path('images/logo.svg'))): ?>
                <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="NOVIN.RO" class="nav-logo-img"/>
            <?php else: ?>
...
<footer class="footer">
    <div class="footer-top">
        ...
        <div>
            <div class="footer-logo">
                <?php if(file_exists(public_path('images/logo.png'))): ?>
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="NOVIN.RO" class="footer-logo-img"/>
                <?php elseif(file_exists(public_path('images/logo.svg'))): ?>
                    <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="NOVIN.RO" class="footer-logo-img"/>
                <?php else: ?>
        ...
        <div>
            ...
            <div class="footer-col-links">
                <a href="<?php echo e(route('home')); ?>">Audit nou</a>
    ...
    <div style="max-width:1200px;margin:0 auto;padding:0 24px 40px;display:flex;align-items:center;gap:20px;">
        <a href="https://anpc.ro/ce-este-sal/" target="_blank" rel="noopener">
            <?php if(file_exists(public_path('images/SAL.png'))): ?>
                <img src="<?php echo e(asset('images/SAL.png')); ?>" alt="SAL ANPC" style="height:40px;width:auto;opacity:.7;transition:opacity .2s;" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=.7"/>
            <?php else: ?>
                <span style="font-size:11px;color:rgba(255,255,255,.3);">SAL - ANPC</span>
            <?php endif; ?>
        </a>
        <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener">
            <?php if(file_exists(public_path('images/SOL.png'))): ?>
                <img src="<?php echo e(asset('images/SOL.png')); ?>" alt="SOL EC" style="height:40px;width:auto;opacity:.7;transition:opacity .2s;" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=.7"/>
            <?php else: ?>
    ...
    <div class="footer-bottom">
        <span class="footer-copy">© <?php echo e(date('Y')); ?> VOID SFT GAMES SRL &nbsp;&bull;&nbsp; CUI 43474393 &nbsp;&bull;&nbsp; Toate drepturile rezervate</span>
    </div>
</footer>
...
</html><?php /**PATH C:\Users\iorda\Desktop\audit_inovex\audit-platform\resources\views/layouts/app.blade.php ENDPATH**/ ?>