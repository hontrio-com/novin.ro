...
<?php $__env->startSection('title', 'Se analizeaza — Inovex Audit'); ?>
...
<div class="progress-page">
    <div class="pp-left">
        <div class="pp-left-inner">
            ...
            <div class="pp-url-badge"><?php echo e($audit->url); ?></div>
...
(function(){
    ...
    const poll = setInterval(async () => {
        try {
            const r = await fetch('/api/audit/<?php echo e($audit->id); ?>/status');
    ...
    document.addEventListener('visibilitychange', function() {
        if (document.visibilityState === 'visible' && !window._auditDone) {
            ...
            fetch('/api/audit/<?php echo e($audit->id); ?>/status')
                .then(r => r.json())
                .then(d => {
                    if (d.status === 'completed' && d.redirect) {
                        window._auditDone = true;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\iorda\Desktop\audit_inovex\audit-platform\resources\views/audit/progress.blade.php ENDPATH**/ ?>