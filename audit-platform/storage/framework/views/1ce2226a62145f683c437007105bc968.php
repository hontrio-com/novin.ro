...
<?php $__env->startSection('title', 'Raport Audit — ' . parse_url($audit->url, PHP_URL_HOST)); ?>
...
<div class="rh">
    <div class="rh-inner">
        <div>
            <div class="rh-bread"><a href="<?php echo e(route('home')); ?>">Inovex Audit</a><span>/</span><span>Raport</span></div>
            <h1 class="rh-url"><?php echo e($audit->url); ?></h1>
            <div class="rh-tags">
                <?php if($critical>0): ?><span class="chip chip-red"><?php echo e($critical); ?> <?php echo e($critical===1?'problema critica':'probleme critice'); ?></span><?php endif; ?>
                <?php if($warnings>0): ?><span class="chip chip-amber"><?php echo e($warnings); ?> <?php echo e($warnings===1?'avertisment':'avertismente'); ?></span><?php endif; ?>
                <?php if($info>0): ?><span class="chip chip-green"><?php echo e($info); ?> <?php echo e($info===1?'observatie':'observatii'); ?></span><?php endif; ?>
            </div>
            <div class="rh-meta">
                <span>Generat: <?php echo e($audit->completed_at ? $audit->completed_at->format('d.m.Y, H:i') : 'acum'); ?></span>
                <div class="rh-meta-dot"></div><span>Disponibil 30 de zile</span>
                <div class="rh-meta-dot"></div><span><?php echo e($audit->email); ?></span>
            </div>
        </div>
        <div class="score-w">
            ...
            <div class="score-ring">
                <svg viewBox="0 0 110 110">
                    ...
                    <circle class="score-fill" cx="55" cy="55" r="50" stroke="<?php echo e($scoreColor); ?>" stroke-dashoffset="<?php echo e(number_format($offset,2)); ?>"/>
                </svg>
                <div class="score-num">
                    <span class="score-n" style="color:<?php echo e($scoreColor); ?>"><?php echo e($score); ?></span>
                    <span class="score-d">/100</span>
                </div>
            </div>
            <a href="<?php echo e(route('audit.pdf', $audit->public_token)); ?>" class="btn-pdf">
...
<div class="rb">
    ...
    <div class="cat-row" data-reveal>
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $s=$cat['score']; $cc=$s>=80?'c-green':($s>=50?'c-amber':'c-red'); $bc=$s>=80?'b-green':($s>=50?'b-amber':'b-red'); ?>
            <div class="cs">
                <div class="cs-lbl"><?php echo e($cat['label']); ?></div>
                <div class="cs-n <?php echo e($cc); ?>"><?php echo e($s); ?></div>
                <div class="cs-bar"><div class="cs-fill <?php echo e($bc); ?>" style="width:<?php echo e($s); ?>%"></div></div>
            </div>
    ...
    <div class="qw-section" data-reveal>
        <div class="qw-header">
            ...
            <div>
                ...
                <div class="qw-sub">Top <?php echo e($quickWins->count()); ?> probleme cu efort mic și impact mare, identificate automat</div>
            </div>
        </div>
        <div class="qw-grid">
            ...
            ?>
            <div class="qw-card">
                <div class="qw-card-rank"><?php echo e($i + 1); ?></div>
                <div class="qw-card-top">
                    <div class="qw-card-sev qw-sev-<?php echo e($issue->severity); ?>">
                        <span style="width:6px;height:6px;border-radius:50%;background:currentColor;display:inline-block;flex-shrink:0"></span>
                        <?php echo e($issue->severity === 'critical' ? 'Critic' : 'Avertisment'); ?>

                    </div>
                    <div class="qw-card-title"><?php echo e($issue->title); ?></div>
                    <div class="qw-card-desc"><?php echo e(Str::limit($issue->description, 110)); ?></div>
                </div>
                <div class="qw-card-bottom">
                    <div class="qw-effort">
                        <div class="qw-effort-dots">
                            <?php for($d = 1; $d <= $effortMax; $d++): ?>
                                <div class="qw-effort-dot <?php echo e($d <= $effort ? 'filled' : ''); ?>"></div>
                            <?php endfor; ?>
                        </div>
                        <span><?php echo e($effortLbl); ?></span>
                    </div>
                    <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                        <?php $__currentLoopData = $impacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $cls = $impactCssQw[$imp] ?? 'impact-seo'; ?>
                            <span class="impact-tag <?php echo e($cls); ?>"><?php echo e($imp); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <a class="qw-fix-link" onclick="scrollToIssue('issue-<?php echo e($issue->id); ?>')">
                        Vezi fix
    ...
    <div class="pages-section" data-reveal>
        <div class="pages-header">
            <div class="pages-header-left">
                ...
                <div>
                    ...
                    <div class="pages-sub"><?php echo e($pages->count()); ?> pagini analizate · timp mediu de încărcare <?php echo e($avgLoad ? round($avgLoad).'ms' : 'N/A'); ?><?php echo e($errorPages > 0 ? ' · '.$errorPages.' erori' : ''); ?></div>
                </div>
            </div>
            <div style="display:flex;align-items:center;gap:8px;">
                <span style="font-size:24px;font-weight:800;letter-spacing:-1px;color:var(--ink)"><?php echo e($pages->count()); ?></span>
        ...
        <div class="pages-types">
            <?php $__currentLoopData = $typeOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <div class="type-pill">
                    <span><?php echo e($icons[$type] ?? '📄'); ?></span>
                    <span><?php echo e($labels[$type] ?? $type); ?></span>
                    <span class="type-pill-count"><?php echo e($typeCounts[$type]); ?></span>
                </div>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="pages-table-wrap">
            <table class="pages-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $pages->sortBy(fn($p) => array_search($p->page_type, $typeOrder)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <tr>
                        <td>
                            <span class="pt-url" title="<?php echo e($page->url); ?>"><?php echo e($page->url); ?></span>
                            <?php if($page->title): ?>
                                <span class="pt-title"><?php echo e($page->title); ?></span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <span class="pt-type">
                                <?php echo e($page->pageTypeIcon()); ?> <?php echo e($page->pageTypeLabel()); ?>

                            </span>
                        </td>
                        <td>
                            <?php $sc = $page->status_code ?? 0; ?>
                            <?php if($sc): ?>
                                <?php
                                    $sCls = $sc < 300 ? 'status-good' : ($sc < 400 ? 'status-redirect' : 'status-error');
                                ?>
                                <span class="status-badge <?php echo e($sCls); ?>"><?php echo e($sc); ?></span>
                            <?php else: ?>
                                <span class="status-badge status-na">N/A</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php $ltCls = $page->loadTimeClass(); ?>
                            <span class="load-badge load-<?php echo e($ltCls); ?>"><?php echo e($page->formattedLoadTime()); ?></span>
                        </td>
                        <td>
                            <?php if($page->images_missing_alt > 0): ?>
                                <span style="color:var(--amber);font-weight:700;font-size:12px;"><?php echo e($page->images_missing_alt); ?>/<?php echo e($page->images_total); ?></span>
                            <?php else: ?>
                                <span style="color:var(--ink-6);font-size:12px;"><?php echo e($page->images_total > 0 ? '✓ '.$page->images_total : '—'); ?></span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <div class="pt-issues">
                                <?php for($i=0; $i<min($criticalCount,5); $i++): ?>
                                    <div class="pt-issue-dot critical" title="Problemă critică"></div>
                                <?php endfor; ?>
                                <?php for($i=0; $i<min($warningCount,5); $i++): ?>
    ...
    <div class="cwv-section" data-reveal>
        <div class="cwv-header">
            ...
            <?php if($mobileScore !== null || $desktopScore !== null): ?>
            <div style="display:flex;align-items:center;gap:16px;">
                <?php if($mobileScore !== null): ?>
                <div style="text-align:center;">
                    <div style="font-size:10px;color:var(--ink-5);font-weight:600;text-transform:uppercase;margin-bottom:3px;">Mobile</div>
                    <div style="font-size:22px;font-weight:800;letter-spacing:-1px;color:<?php echo e($msColor); ?>;"><?php echo e($mobileScore); ?></div>
                </div>
                <?php endif; ?>
                <?php if($desktopScore !== null): ?>
                <div style="text-align:center;">
                    <div style="font-size:10px;color:var(--ink-5);font-weight:600;text-transform:uppercase;margin-bottom:3px;">Desktop</div>
                    <div style="font-size:22px;font-weight:800;letter-spacing:-1px;color:<?php echo e($dsColor); ?>;"><?php echo e($desktopScore); ?></div>
                </div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
        ...
        <div class="cwv-metrics" id="cwvMetrics">
            <?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="cwv-metric">
                    <?php if($m['core']): ?><div class="cwv-core-label">CWV</div><?php endif; ?>
                    <div class="cwv-metric-name"><?php echo e($m['label']); ?></div>
                    <div class="cwv-metric-badge <?php echo e($cls); ?>">
                        <?php if($cls === 'good'): ?>
                    ...
                    <div class="cwv-metric-val"><?php echo e($disp ?? 'N/A'); ?></div>
                    <div class="cwv-metric-threshold"><?php echo e($m['thresh']); ?></div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="cwv-compare">
            ...
            <div class="cwv-strategy">
                ...
                <div class="cwv-score-bar-wrap">
                    <div class="cwv-score-bar" style="width:<?php echo e($mobileScore); ?>%;background:<?php echo e($msColor); ?>;"></div>
                </div>
                <span class="cwv-strategy-score" style="color:<?php echo e($msColor); ?>"><?php echo e($mobileScore); ?>/100</span>
            </div>
            <?php endif; ?>
            <?php if($desktopScore !== null): ?>
            <div class="cwv-strategy">
                ...
                <div class="cwv-score-bar-wrap">
                    <div class="cwv-score-bar" style="width:<?php echo e($desktopScore); ?>%;background:<?php echo e($dsColor); ?>;"></div>
                </div>
                <span class="cwv-strategy-score" style="color:<?php echo e($dsColor); ?>"><?php echo e($desktopScore); ?>/100</span>
            </div>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <?php if($lighthouseIssues->count() > 0): ?>
        <div class="cwv-opps">
            <div class="cwv-opps-toggle" onclick="toggleOpps(this)">
                <div class="cwv-opps-toggle-left">
                    ...
                    <span class="cwv-opps-count"><?php echo e($lighthouseIssues->count()); ?></span>
                </div>
                <svg class="cwv-chevron" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg>
            </div>
            <div class="cwv-opps-body" id="cwvOppsBody">
                <?php $__currentLoopData = $lighthouseIssues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="cwv-opp-row">
                    <div class="cwv-opp-sev <?php echo e($issue->severity); ?>"></div>
                    <div class="cwv-opp-label"><?php echo e($issue->title); ?></div>
                    <?php if($issue->suggestion): ?>
                        <div class="cwv-opp-savings" style="color:var(--ink-4);font-weight:400;font-size:11px;max-width:300px;text-align:right;"><?php echo e(Str::limit($issue->suggestion, 80)); ?></div>
                    <?php endif; ?>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(isset($issuesByCategory[$key]) && $issuesByCategory[$key]->count() > 0): ?>
            <?php $s=$cat['score']; $cc=$s>=80?'c-green':($s>=50?'c-amber':'c-red'); ?>
            <div class="issue-group" data-reveal>
                <div class="ig-head">
                    <div class="ig-ico"><svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" stroke="currentColor"><?php echo $cat['icon']; ?></svg></div>
                    <span class="ig-name"><?php echo e($cat['label']); ?></span>
                    <span class="ig-cnt"><?php echo e($issuesByCategory[$key]->count()); ?> <?php echo e($issuesByCategory[$key]->count() === 1 ? 'problemă' : 'probleme'); ?></span>
                    <span class="ig-score <?php echo e($cc); ?>"><?php echo e($s); ?>/100</span>
                </div>
                <div class="issues">
                    <?php $__currentLoopData = $issuesByCategory[$key]->sortBy(fn($i)=>match($i->severity){'critical'=>0,'warning'=>1,default=>2}); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <div class="issue sev-<?php echo e($issue->severity); ?>" id="<?php echo e($issueId); ?>">
                            
                            <div class="issue-head" onclick="toggleIssue('<?php echo e($issueId); ?>')">
                                <div class="issue-dot d-<?php echo e($issue->severity); ?>"></div>
                                <div class="issue-head-body">
                                    <div class="issue-title"><?php echo e($issue->title); ?></div>
                                    <div class="issue-meta">
                                        
                                        <?php $__currentLoopData = $impacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $cls = $impactCss[$imp] ?? 'impact-seo'; ?>
                                            <span class="impact-tag <?php echo e($cls); ?>"><?php echo e($imp); ?></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($issue->affected_url): ?>
                                            <span class="issue-url-tag" title="<?php echo e($issue->affected_url); ?>"><?php echo e(Str::limit($issue->affected_url, 35)); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="issue-body">
                                ...
                                <div class="issue-desc"><?php echo e($issue->description); ?></div>

                                
                                <?php if($stepData): ?>
                                    <div class="issue-steps">
                                        <div class="issue-steps-title">Cum rezolvi</div>
                                        <?php $__currentLoopData = $stepData['steps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="issue-step">
                                                <div class="issue-step-num"><?php echo e($si + 1); ?></div>
                                                <div class="issue-step-txt"><?php echo e($step); ?></div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php elseif($issue->suggestion): ?>
                                    <div class="issue-steps">
                                        <div class="issue-steps-title">Cum rezolvi</div>
                                        <div class="issue-step">
                                            <div class="issue-step-num">1</div>
                                            <div class="issue-step-txt"><?php echo e($issue->suggestion); ?></div>
                                        </div>
                                    </div>
                                <?php endif; ?>

                                
                                <?php if($stepData && isset($stepData['verify'])): ?>
                                    <div class="issue-verify">
                                        <svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>
                                        <span><strong>Cum verifici că e rezolvat:</strong> <?php echo e($stepData['verify']); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\iorda\Desktop\audit_inovex\audit-platform\resources\views/audit/report.blade.php ENDPATH**/ ?>